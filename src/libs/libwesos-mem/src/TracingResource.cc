...
SYM_EXPORT auto TracingResource::virt_do_allocate(usize size, PowerOfTwo<usize> align) -> NullableOwnPtr<u8> {
...
SYM_EXPORT void TracingResource::virt_do_deallocate(OwnPtr<u8> ptr, usize size, PowerOfTwo<usize> align) {
